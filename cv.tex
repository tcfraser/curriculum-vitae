    ...
    \section{Academic Works}
        ...
        \academicsection{Course Notes}{
            \begin{coursenotelist}
                ...
                \item{Fall 2016}{\href{https://github.com/tcfraser/course-notes/raw/master/notes/applied-probability/applied-probability.pdf}{Applied Probability} (In progress)}{}
                \item{Fall 2016}{\href{https://github.com/tcfraser/course-notes/raw/master/notes/quantum-physics-three/quantum-physics-three.pdf}{Quantum Physics 3} (In progress)}{}
                \item{Fall 2016}{\href{https://github.com/tcfraser/course-notes/raw/master/notes/electricity-magnetism-three/electricity-magnetism-three.pdf}{Electricity \& Magnetism 3} (In progress)}{}
                \item{Fall 2016}{\href{https://github.com/tcfraser/course-notes/raw/master/notes/cosmology/cosmology.pdf}{Cosmology} (In progress)}{}
            \end{coursenotelist}
        }
        ...
        \academicsection{Manuscripts in Preparation (Drafts Available Upon Request)}
        {
            \begin{paperlist}
                \item{January 2017}
