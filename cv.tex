...
\begin{document}
    ...
    \begin{educationlist}
        \item{2012 -- 2017}
             ...
             {Cumulative Average: \textbf{98.00\%}}
    ...
    \section{Academic Works}
        ...
        \academicsection{Course Notes (Hyperlinked)}{
            \begin{coursenotelist}
                ...
                \item{Winter 2017}{\href{https://github.com/tcfraser/course-notes/raw/master/notes/topics-condensed-matter/topics-condensed-matter.pdf}{Topics in Condensed Matter Physics} (In progress)}{}
            \end{coursenotelist}
        }
